...
enum Setting: String {
    ...
    static func registerDefaults() {
        UserDefaults.standard.register(defaults: [
            ...
            Setting.keepCubeOnSurface.rawValue: true
        ])
    }
}
...
class SettingsViewController: UITableViewController {
    ...
    @IBOutlet weak var keepCubeOnSurfaceSwitch: UISwitch!
	...
	@IBAction func didChangeSetting(_ sender: UISwitch) {
		...
		switch sender {
            ...
            case keepCubeOnSurfaceSwitch:
                defaults.set(sender.isOn, for: .keepCubeOnSurface)
            default: break
		}
	}
	...
	private func populateSettings() {
        ...
        keepCubeOnSurfaceSwitch.isOn = defaults.bool(for: .keepCubeOnSurface)
	}
}
